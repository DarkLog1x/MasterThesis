...
The last several years cloud computing has steadily grown (Figure \ref{fig:CloudTrendGoogle}) as a business.  With it has its exposer so has the cyber security epidemic \cite[kellerman2010cyber]. Cloud systems are now a major target for cyber criminals.  
