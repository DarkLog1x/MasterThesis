...
The last several years cloud computing has steadily grown \ref{fig:CloudTrendGoogle} and with it has its exposer to the cyber security epidemic \cite[kellerman2010cyber]. 

\begin{wrapfigure}{lht}{0.6\textwidth}
    \includegraphics[scale=.2]{./pic/2017-06-14-130823_923x615_scrot.png}
    \caption{Cloud computing trend from Google}
    \label{fig:CloudTrendGoogle}
\end{wrapfigure}
It is almost on a weekly bases that news of another security breach has effected a company. As cloud computing is becoming more and more popular, corporations are switching over to this new model. This switch bring about new challenges, especial in the security spacei involving cloud systems. The large majority of these cloud computing systems are provided as public clouds, these are further described below. However another sector of cloud computing called private clouds has recently been gaining popularity \ref{fig:PrivCloudTrendGoogle}. As private clouds don't have the backing of large corporations dedicated to ensuring a secure environment vulnerabilities can become present. 


\begin{wrapfigure}{lht}{0.6\textwidth}
    \includegraphics[scale=.2]{./pic/2017-06-14-135222_914x619_scrot.png}
    \caption{Private cloud computing trend from Google}
